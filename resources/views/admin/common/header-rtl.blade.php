<header class="d-rtl">
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="position-relative search-bar d-lg-none" data-bs-toggle="modal"
            ...
            <div class="user-box dropdown px-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end d-rtl">
                    <li>
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{ route('admin.panel') }}">
