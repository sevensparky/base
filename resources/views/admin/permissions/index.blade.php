...
@section('title', __('admin_panel_permissions'))
    ...
    <div class="card radius-10 {{ app()->getLocale('fa') ? 'd-rtl' : '' }}">
        <div class="card-header">
            <div class="d-flex align-items-center">
                <div>
                    <h6 class="mb-0">{{ __('permission_management') }}</h6>
                </div>
                ...
                <div class="dropdown ms-auto">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('permissions.create') }}">{{ __('create_permission') }}</a>
                        </li>
                        <li>
                                ...
                                <td>
                                    <div class="col-md-12">
                                        <div class="d-md-flex d-grid align-items-center justify-content-center gap-3">
                                            <a href="{{ route('permissions.edit', $permission->id) }}" type="buttom" class="btn btn-sm btn-warning px-4">{{ __('edit') }}</a>
