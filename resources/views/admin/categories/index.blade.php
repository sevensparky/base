...
@section('title', __('admin_panel_categories'))
                ...
                <div class="dropdown ms-auto">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item"
                                href="{{ route('categories.create') }}">{{ __('create_new_category') }}</a>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="{{ route('admin.panel') }}">{{ __('back_to_dashboard') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    <td>
                                        <div class="col-md-12">
                                            <div class="d-md-flex d-grid align-items-center justify-content-center gap-3">
                                                <a href="{{ route('categories.edit', $category->id) }}" type="buttom"
