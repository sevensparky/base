    ...
    <div class="card radius-10 {{ app()->getLocale('fa') ? 'd-rtl' : '' }}">
        <div class="card-header">
            <div class="d-flex align-items-center">
                <div>
                    <h6 class="mb-0">{{ __('user-role_for_users') }}</h6>
                </div>
                ...
                <div class="dropdown ms-auto">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="{{ route('user-role.create') }}">{{ __('submit_user-role') }}</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('admin.panel') }}">{{ __('back_to_dashboard') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    @foreach ($role->users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-md-12">
                                                    <div
                                                        class="d-md-flex d-grid align-items-center justify-content-center gap-3">
                                                        <a href="{{ route('user-role.edit', $user->id) }}" type="buttom"
                                                        ...
                                                        <form action="{{ route('user-role.destroy', $user->id) }}"
                                                            ...
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="btn btn-sm btn-danger px-4 deleteItem">{{ __('delete') }}</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </td>
